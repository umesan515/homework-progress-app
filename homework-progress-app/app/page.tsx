  ...
  return (
    <main className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <Link className="rounded-xl border p-4 hover:bg-gray-100 hover:shadow-sm transition" href="/teacher/materials">
          <div className="font-semibold">教材置き場</div>
          <div className="text-sm text-gray-600">図・動画・操作教材の登録と公開設定</div>
        </Link>
      </div>
